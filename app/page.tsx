      ...
      <header className="sticky top-0 z-50 flex flex-col shadow-sm bg-white">
        ...
        <div className="flex items-center justify-between px-4 md:px-6 lg:px-8 py-3 border-b border-gray-100">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:flex items-center ml-8 text-sm group cursor-pointer">
          ...
          <div className="flex items-center space-x-4 lg:space-x-6">
            <button className="hidden sm:flex text-gray-600 hover:text-[#1E6FD9] transition-colors p-2">
              <Phone className="w-5 h-5" />
            </button>
            <button className="text-gray-600 hover:text-[#1E6FD9] transition-colors p-2 relative">
              <Bell className="w-5 h-5" />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full border-2 border-white"></span>
            </button>
            <Link href="/cart" className="text-gray-600 hover:text-[#1E6FD9] transition-colors p-2 relative">
              <ShoppingCart className="w-5 h-5" />
              <span className="absolute top-0 right-0 bg-[#4CAF50] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border border-white">2</span>
            </Link>

            <Link href="/login" className="hidden sm:flex items-center gap-2 border border-gray-200 hover:border-[#1E6FD9] hover:bg-blue-50 px-4 py-2 rounded-lg text-sm font-semibold text-[#1E6FD9] transition-colors">
        ...
        <nav className="hidden md:block bg-[#4CAF50] text-white w-full">
          <div className="container mx-auto px-4 lg:px-8">
            <ul className="flex items-center justify-between xl:justify-start xl:space-x-8 text-sm font-medium py-3 overflow-x-auto whitespace-nowrap scrollbar-hide">
              <li className="cursor-pointer hover:text-green-100 transition-colors">Medicines</li>
              <Link href="/our-products">
                <li className="cursor-pointer hover:text-green-100 transition-colors">Our Products</li>
              </Link>
              <li className="cursor-pointer hover:text-green-100 transition-colors">Lab Test Booking</li>
              <li className="cursor-pointer hover:text-green-100 transition-colors">Health Plus</li>
              <li className="cursor-pointer hover:text-green-100 transition-colors flex items-center gap-1">
                Healthcare Services <ChevronDown className="w-[14px] h-[14px]" />
              </li>
              <li className="cursor-pointer text-yellow-300 font-bold hover:text-yellow-100 transition-colors">Today&apos;s Deals</li>
        ...
        <nav className="hidden md:block bg-gray-100/80 border-b border-gray-200 text-gray-600 w-full backdrop-blur-sm">
          <div className="container mx-auto px-4 lg:px-8">
            <ul className="flex items-center space-x-8 text-xs font-semibold py-2.5 overflow-x-auto whitespace-nowrap">
              <li className="cursor-pointer hover:text-[#1E6FD9] transition-colors flex items-center gap-1"><Stethoscope className="w-[14px] h-[14px]" /> Doctor</li>
              <li className="cursor-pointer hover:text-[#1E6FD9] transition-colors flex items-center gap-1"><FileText className="w-[14px] h-[14px]" /> Upload Prescription</li>
              <li className="cursor-pointer hover:text-[#1E6FD9] transition-colors flex items-center gap-1"><ShieldCheck className="w-[14px] h-[14px]" /> Insurance</li>
        ...
        <div className={`md:hidden fixed inset-0 z-40 bg-white pt-32 px-4 overflow-y-auto ${isMenuOpen ? 'block' : 'hidden'}`}>
          <div className="flex flex-col space-y-4 text-lg font-semibold text-gray-800">
            <div className="border-b pb-4">
              <Link href="/login" onClick={() => setIsMenuOpen(false)} className="flex w-full items-center gap-2 bg-[#1E6FD9] text-white px-4 py-3 rounded-xl justify-center">
                <User className="w-5 h-5" /> Login / Sign Up
              </Link>
            </div>
            <Link href="#" className="flex justify-between items-center py-2">Medicines <ChevronRight className="w-[18px] h-[18px] text-gray-400" /></Link>
            <Link href="#" className="flex justify-between items-center py-2">Lab Tests <ChevronRight className="w-[18px] h-[18px] text-gray-400" /></Link>
            <Link href="#" className="flex justify-between items-center py-2">Consult Doctor <ChevronRight className="w-[18px] h-[18px] text-gray-400" /></Link>
            <Link href="#" className="flex justify-between items-center py-2 text-[#4CAF50]">Upload Prescription <ChevronRight className="w-[18px] h-[18px] text-gray-400" /></Link>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 lg:px-8 py-6 space-y-12">
          ...
          <div className="relative z-10 p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center justify-between">
            <div className="max-w-xl space-y-4 mb-8 md:mb-0">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <button className="bg-[#4CAF50] hover:bg-green-600 text-white px-6 py-3 rounded-xl font-bold transition-transform hover:scale-105 active:scale-95 shadow-md flex items-center gap-2">
                  Order Medicines <ArrowRight className="w-[18px] h-[18px]" />
                </button>
                <button className="bg-white hover:bg-blue-50 text-[#1E6FD9] px-6 py-3 rounded-xl font-bold transition-colors shadow-md flex items-center gap-2">
        ...
        <section>
          <div className="flex justify-between items-end mb-6">
            ...
            <button className="text-[#1E6FD9] font-semibold text-sm hover:underline flex items-center">View All <ChevronRight className="w-4 h-4" /></button>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            
            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-3 group-hover:bg-[#1E6FD9] transition-colors">
                <Pill className="w-7 h-7 text-[#1E6FD9] group-hover:text-white transition-colors" />
              </div>
              <span className="text-sm font-semibold text-gray-700 leading-tight">Medicine</span>
            </div>
            
            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-3 group-hover:bg-[#1E6FD9] transition-colors">
                <Activity className="w-7 h-7 text-[#1E6FD9] group-hover:text-white transition-colors" />
              </div>
              <span className="text-sm font-semibold text-gray-700 leading-tight">Healthcare Devices</span>
            </div>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              ...
              <span className="text-sm font-semibold text-gray-700 leading-tight">Skin Care</span>
            </div>

            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-3 group-hover:bg-[#1E6FD9] transition-colors">
                <Baby className="w-7 h-7 text-[#1E6FD9] group-hover:text-white transition-colors" />
              </div>
              <span className="text-sm font-semibold text-gray-700 leading-tight">Baby Care</span>
            </div>

            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-3 group-hover:bg-[#1E6FD9] transition-colors">
                <HeartPulse className="w-7 h-7 text-[#1E6FD9] group-hover:text-white transition-colors" />
              </div>
              <span className="text-sm font-semibold text-gray-700 leading-tight">Diabetes Care</span>
            </div>

            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-3 group-hover:bg-[#1E6FD9] transition-colors">
                <Leaf className="w-7 h-7 text-[#1E6FD9] group-hover:text-white transition-colors" />
              </div>
              <span className="text-sm font-semibold text-gray-700 leading-tight">Ayurvedic</span>
            </div>

            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-3 group-hover:bg-[#1E6FD9] transition-colors">
                <ShieldPlus className="w-7 h-7 text-[#1E6FD9] group-hover:text-white transition-colors" />
              </div>
              <span className="text-sm font-semibold text-gray-700 leading-tight">Vitamins & Supps</span>
            </div>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer flex flex-col items-center text-center group border border-transparent hover:border-blue-100">
              ...
              <span className="text-sm font-semibold text-gray-700 leading-tight">Personal Care</span>
            </div>
        ...
        <section>
          ...
          <div className="flex overflow-x-auto gap-6 pb-6 snap-x snap-mandatory scrollbar-hide -mx-4 px-4 lg:mx-0 lg:px-0">
            ...
            {/* Product Card 1 */}
            <div className="min-w-[240px] max-w-[240px] snap-start bg-white rounded-2xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col hover:shadow-lg transition-shadow relative">
              <div className="absolute top-4 left-4 z-10 bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded-md">30% OFF</div>
              <div className="w-full h-40 bg-gray-50 rounded-xl mb-4 flex items-center justify-center overflow-hidden">
                <img src="/assets/products/nivimeds_headache_relief_balm.png" alt="Nivimeds Product" className="h-full w-full object-contain p-4" />
              </div>
              <div className="flex-1 flex flex-col">
                <h3 className="font-semibold text-gray-800 leading-snug line-clamp-2 mb-2">Nivimeds Headache Relief Balm</h3>
                <div className="flex items-center gap-1 mb-3 mt-auto">
                  <Star className="w-[14px] h-[14px] fill-yellow-400 text-yellow-400" />
                  <span className="text-xs font-bold text-gray-700">4.8</span>
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-lg font-extrabold text-[#1E6FD9]">₹349</span>
                  <span className="text-sm text-gray-400 line-through">₹499</span>
                </div>
                <button className="w-full bg-white border-2 border-[#1E6FD9] text-[#1E6FD9] hover:bg-[#1E6FD9] hover:text-white py-2 rounded-xl font-bold transition-colors text-sm">
                  Add to Cart
                </button>
              </div>
            </div>
            ...
            {/* Product Card 2 */}
            <div className="min-w-[240px] max-w-[240px] snap-start bg-white rounded-2xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col hover:shadow-lg transition-shadow relative">
              <div className="absolute top-4 left-4 z-10 bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded-md">25% OFF</div>
              <div className="w-full h-40 bg-gray-50 rounded-xl mb-4 flex items-center justify-center overflow-hidden">
                <img src="/assets/products/nivimeds_ortho_pain_relief_roll-On.png" alt="Nivimeds Product" className="h-full w-full object-contain p-4" />
              </div>
              <div className="flex-1 flex flex-col">
                <h3 className="font-semibold text-gray-800 leading-snug line-clamp-2 mb-2">Nivimeds Ortho Pain Relief Roll-On</h3>
                <div className="flex items-center gap-1 mb-3 mt-auto">
                  <Star className="w-[14px] h-[14px] fill-yellow-400 text-yellow-400" />
                  <span className="text-xs font-bold text-gray-700">4.6</span>
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-lg font-extrabold text-[#1E6FD9]">₹899</span>
            ...
            <div className="min-w-[240px] max-w-[240px] snap-start bg-white rounded-2xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col hover:shadow-lg transition-shadow relative">
              <div className="absolute top-4 left-4 z-10 bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded-md">25% OFF</div>
              <div className="w-full h-40 bg-gray-50 rounded-xl mb-4 flex items-center justify-center overflow-hidden">
                <img src="/assets/products/nivimeds_stress_relief_roll-on.png" alt="Nivimeds Product" className="h-full w-full object-contain p-4" />
              </div>
              <div className="flex-1 flex flex-col">
                <h3 className="font-semibold text-gray-800 leading-snug line-clamp-2 mb-2">Nivimeds Stress Relief Roll-On</h3>
                <div className="flex items-center gap-1 mb-3 mt-auto">
                  <Star className="w-[14px] h-[14px] fill-yellow-400 text-yellow-400" />
                  <span className="text-xs font-bold text-gray-700">4.9</span>
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-lg font-extrabold text-[#1E6FD9]">₹450</span>
            ...
            {/* Product Card 4 */}
            <div className="min-w-[240px] max-w-[240px] snap-start bg-white rounded-2xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col hover:shadow-lg transition-shadow relative">
              <div className="absolute top-4 left-4 z-10 bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded-md">33% OFF</div>
              <div className="w-full h-40 bg-gray-50 rounded-xl mb-4 flex items-center justify-center overflow-hidden">
                <img src="/assets/products/nivimeds_herbal_Inhaler.png" alt="Nivimeds Product" className="h-full w-full object-contain p-4" />
              </div>
              <div className="flex-1 flex flex-col">
                <h3 className="font-semibold text-gray-800 leading-snug line-clamp-2 mb-2">Nivimeds Herbal Inhaler</h3>
                <div className="flex items-center gap-1 mb-3 mt-auto">
                  <Star className="w-[14px] h-[14px] fill-yellow-400 text-yellow-400" />
                  <span className="text-xs font-bold text-gray-700">4.7</span>
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-lg font-extrabold text-[#1E6FD9]">₹599</span>
            ...
            {/* Product Card 5 */}
            <div className="min-w-[240px] max-w-[240px] snap-start bg-white rounded-2xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col hover:shadow-lg transition-shadow relative">
              <div className="absolute top-4 left-4 z-10 bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded-md">21% OFF</div>
              <div className="w-full h-40 bg-gray-50 rounded-xl mb-4 flex items-center justify-center overflow-hidden">
                <img src="/assets/products/nivimeds_herbal_mouth_mist.png" alt="Nivimeds Product" className="h-full w-full object-contain p-4" />
              </div>
              <div className="flex-1 flex flex-col">
                <h3 className="font-semibold text-gray-800 leading-snug line-clamp-2 mb-2">Nivimeds Herbal Mouth Mist</h3>
                <div className="flex items-center gap-1 mb-3 mt-auto">
                  <Star className="w-[14px] h-[14px] fill-yellow-400 text-yellow-400" />
                  <span className="text-xs font-bold text-gray-700">4.5</span>
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-lg font-extrabold text-[#1E6FD9]">₹750</span>
                  <span className="text-sm text-gray-400 line-through">₹950</span>
                </div>
                <button className="w-full bg-white border-2 border-[#1E6FD9] text-[#1E6FD9] hover:bg-[#1E6FD9] hover:text-white py-2 rounded-xl font-bold transition-colors text-sm">
                  Add to Cart
                </button>
        ...
        <section className="bg-white p-6 md:p-8 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-blue-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex flex-col p-5 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all group">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 bg-blue-50 text-[#1E6FD9]">
                <Stethoscope className="w-7 h-7" />
              </div>
              <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-[#1E6FD9] transition-colors">Doctor Consultation</h3>
              <p className="text-gray-500 text-sm mb-4 flex-1">Connect with top specialists online or in-clinic.</p>
              <button className="text-[#1E6FD9] font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all mt-auto w-fit">
                Explore <ArrowRight className="w-4 h-4" />
              </button>
            </div>

            <div className="flex flex-col p-5 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all group">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 bg-green-50 text-[#4CAF50]">
                <FlaskConical className="w-7 h-7" />
              </div>
              <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-[#1E6FD9] transition-colors">Lab Test Booking</h3>
              <p className="text-gray-500 text-sm mb-4 flex-1">Book tests from home with free sample collection.</p>
              <button className="text-[#1E6FD9] font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all mt-auto w-fit">
                Explore <ArrowRight className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="flex flex-col p-5 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all group">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 bg-purple-50 text-purple-600">
                <HeartPulse className="w-7 h-7" />
              </div>
              <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-[#1E6FD9] transition-colors">Healthcare Services</h3>
              <p className="text-gray-500 text-sm mb-4 flex-1">Nursing, physiotherapy & more at your doorstep.</p>
              <button className="text-[#1E6FD9] font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all mt-auto w-fit">
                Explore <ArrowRight className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="flex flex-col p-5 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all group">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 bg-orange-50 text-orange-600">
                <ShieldCheck className="w-7 h-7" />
              </div>
              <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-[#1E6FD9] transition-colors">Health Insurance</h3>
              <p className="text-gray-500 text-sm mb-4 flex-1">Protect your family with affordable health plans.</p>
              <button className="text-[#1E6FD9] font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all mt-auto w-fit">
                Explore <ArrowRight className="w-4 h-4" />
              </button>
            </div>
        ...
        <section className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl overflow-hidden relative shadow-xl">
          ...
          <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 text-center min-w-[250px]">
              ...
              <button className="w-full bg-[#4CAF50] hover:bg-green-600 text-white py-3 rounded-xl font-bold shadow-lg transition-transform hover:-translate-y-1">
                Join Membership
              </button>
            </div>
          </div>
        ...
        <section>
          <div className="flex justify-between items-end mb-6">
            ...
            <button className="hidden sm:flex text-[#1E6FD9] font-semibold text-sm hover:underline items-center">View All <ChevronRight className="w-4 h-4" /></button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            <div className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-lg transition-shadow cursor-pointer flex flex-col">
              <div className="h-48 bg-blue-50 relative flex items-center justify-center p-6">
                ...
                <span className="absolute bottom-4 left-4 bg-white/20 backdrop-blur-md text-white text-xs font-bold px-3 py-1 rounded-full z-10">
                  Diabetes Care
                </span>
              </div>
              <div className="p-5 flex flex-col flex-1">
                <h3 className="font-bold text-gray-800 text-lg leading-snug mb-3 group-hover:text-[#1E6FD9] transition-colors line-clamp-2">
                  Understanding Diabetes: A Complete Guide to Managing Sugar Levels
                </h3>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-lg transition-shadow cursor-pointer flex flex-col">
              ...
              <div className="p-5 flex flex-col flex-1">
                <h3 className="font-bold text-gray-800 text-lg leading-snug mb-3 group-hover:text-[#1E6FD9] transition-colors line-clamp-2">
                  Top 10 Immunity Boosting Foods for the Winter Season
                </h3>
                <div className="mt-auto flex items-center justify-between text-sm text-gray-500 font-medium">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-lg transition-shadow cursor-pointer flex flex-col">
              ...
              <div className="p-5 flex flex-col flex-1">
                <h3 className="font-bold text-gray-800 text-lg leading-snug mb-3 group-hover:text-[#1E6FD9] transition-colors line-clamp-2">
                  The Importance of Regular Full Body Health Checkups
                </h3>
                <div className="mt-auto flex items-center justify-between text-sm text-gray-500 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  <button className="bg-gray-900 text-white px-4 py-2 rounded-lg text-xs font-semibold flex items-center gap-2">
                    Apple Store
                  </button>
                  <button className="bg-gray-900 text-white px-4 py-2 rounded-lg text-xs font-semibold flex items-center gap-2">
                    Google Play
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Order Medicines</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Book Lab Tests</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Consult a Doctor</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Ayurveda Articles</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Nivimeds Health Plus</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">About Us</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Careers</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Blog</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Partner with Nivimeds</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Sell on Nivimeds</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Browse All Medicines</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Browse All Molecules</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">FAQs</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Return Policy</Link></li>
                <li><Link href="#" className="hover:text-[#1E6FD9] transition-colors">Contact Us</Link></li>
              </ul>
            </div>
